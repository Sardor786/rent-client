	...
	return (
		<>
			<div className="header">
				<Link className="exitAccount" to="/home">
					<HiLogout />
				</Link>
				<h1 className="title">My Classifieds</h1>
				<Link className="setting" to="/account/settings">
					<FiSettings />
				</Link>
			...
			<ul className="my_classifieds_list">
				{classifieds.data.length > 0 ? (
					classifieds.data.map((cls) => (
						<li
							className="my_classified_item"
							key={cls.classified_id}
						>
							<div className="my_classified_main">
								...
								<div className="my_classified_info">
									<div className="my_cls_header">
										<h1 className="my_classified_title">
											{cls.classified_title}
										</h1>
										<p className="my_classified_price">
									...
									<p className="my_classified_addres">
							...
							<div className="edit_classified_info--modal">
								<div className="edit_cls_header--modal">
									<input
										...
										className="edit_classified_title"
										defaultValue={
									...
									<input
										...
										className="edit_classified_price"
										defaultValue={
								...
								<div className="classified-info classified-info--modal">
									...
									<textarea
										...
										defaultValue={
											classifieds.modal.classified_body
										}
										className="edit_classified_body"
										cols="30"
										rows="10"
			...
			{classifieds.modalImages && (
				<div
					className={imageModalActive(classifieds.modalImages)}
					onClick={closeImages}
				>
					<ul>
						<Slide scale={1}>
						...
						<li>
							<button
								className="comments_close image_btn"
								onClick={() =>
									setCloseImagesModal(
