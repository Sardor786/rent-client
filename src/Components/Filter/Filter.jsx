	...
	return (
		<>
			<form>
				<ul
					className={
						filter ? "filter_list close_filter" : "filter_list"
					}
				>
					<li
						onClick={() => setFilter(true)}
						className={filter ? "none" : "open_close_filter"}
					>
						<span>
							<AiOutlineClose />
						</span>
					...
					<li
						...
						className={filter ? "open_close_filter" : "none"}
					>
						<span>
							<BsArrowRight />
						</span>
					...
					<li className="filter_item">
						...
						<select
							className="filter_select"
							id="rooms"
							onChange={(e) => setRoom({ value: e.target.value })}
						>
							<option key="0" value="0">
								Choose Rooms
							</option>
					...
					<li className="filter_item">
						...
						<input
							...
							id="price_from"
							onKeyUp={(e) => setPriceFrom(e.target.value)}
							type="number"
					...
					<li className="filter_item">
						...
						<input
							className="filter_input"
							id="price_to"
							onKeyUp={(e) => setPriceTo(e.target.value)}
							type="number"
